...
- Фильтры по статусу встроены в summary-карточки (кликабельные, множественный выбор). `toggleFilter()` переключает `activeFilters`, карточка «Всего» сбрасывает фильтры
- Адаптивная верстка (breakpoints: 768px, 400px). На мобильных при скролле заголовок с кнопками скрывается, summary-карточки сжимаются (класс `.scrolled` на `.sticky-header`)
